...
Data is sourced from Hospital Episode Statistics (HES) Outpatient Appointments (OP) dataset.
We extract aggregated appointment level data for a given year.
...
Note that maternity activity is excluded from types of potentially mitigatable activity for Outpatients. This activity is identified with treatment specialty codes `424`, `501`, `505`, and `560`.
