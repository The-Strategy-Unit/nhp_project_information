...
- Previous versions of the model code are version controlled and available on GitHub(). You can view an overview of the [repository structure](/software_implementation/assumptions-log.qmd)
