...
- Previous versions of the model code are version controlled and available on [GitHub](https://github.com/The-Strategy-Unit). You can view an overview of the [repository structure](/quality_assurance/components-overview.qmd).
