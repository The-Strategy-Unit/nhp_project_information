...
Given the size of the project, there are numerous GitHub repositories relating to NHP, with this number likely to grow. This page gives an overview of the main repositories forming the backbone of the model. It is not exhaustive - if there are any queries on repositories not listed here, do contact the [Strategy Unit Data Science team](mailto:mlcsu.su.datascience@nhs.net). 
...
-   [nhp_compare_mitigation_predictions_app](https://github.com/The-Strategy-Unit/nhp_compare_mitigation_predictions_app) (previously known as nhp_inputs_report_app and has links that redirect).
