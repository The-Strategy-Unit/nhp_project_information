...
This repository contains R ode to auto-populate the 'final' (sometimes to referred to as 'outputs') and 'validation' report templates. Generates scheme-specific (and possibly site-specific) charts, tables and values from model-run data and inserts these into the report template (docx).
