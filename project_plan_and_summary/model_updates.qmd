...
This change has meant that users will [notice some differences](#method-change) in the waterfall diagram found on the "impact of changes" tab of the outputs dashboard. 
