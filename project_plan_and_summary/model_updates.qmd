...
A&E data now includes A&E follow-up activity. This may mean that you see larger numbers in A&E data in v3.0 onwards. The outputs app currently does not seperate out this activity, but it is available in the data downloads.
