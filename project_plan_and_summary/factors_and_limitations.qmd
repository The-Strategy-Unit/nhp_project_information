...
The main outputs will be activity levels which will then be converted to high-level capacity requirements (number of beds in version 0.6; theatres and wards forthcoming). The model will use these outputs to inform work with other NHP workstreams and Trusts/ICSs, but will not go beyond basic capacity calculations at this stage. Further breakdowns of specific capacity will need to be undertaken by Trusts, informed by activity breakdowns.
