...
It is not unreasonable to assume such factors are likely to have a continued effect on future demand. As such our view is that the use of the baseline level of non demographic  growth [is reasonable](https://connect.strategyunitwm.nhs.uk/nhp/project_information/modelling_methodology/ndg_analysis.html). This position is supported by a separate elicitation exercise that resulted in similar annual growth estimates.
