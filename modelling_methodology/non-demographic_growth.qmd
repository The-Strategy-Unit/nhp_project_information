...
The analyses underpinning Variant 2 are available as documents:

- [Estimating the impact of non-demographic effects on hospital activity growth in England | 2011-2019](ndg_analysis.html) published October 2023
- [Estimating the impacts of activity mitigation efforts on activity growth | 2011-2019](ndg2_analysis.html) published November 2023

The latter analysis determined the NDG rate applied to non-elective IP admissions. This work has also been published in an open access [peer-reviewed academic journal](https://doi.org/10.1186/s12913-025-13662-0) published 17 December 2025.

A pdf report detailing the expert elicitation exercise which underpins Variant 3:

- [Long term prediction intervals for residual growth in English hospitals: a national elicitation exercise providing an outside view based on judgements of experts in support of the New Hospital Programme](residual_growth_elicitation_02Dec2024.pdf) published 02 December 2024
...
More detail describing the adoption of Variant 2 as the model's primary rate for non-elective inpatient admissions can be found in a [previous iteration](https://github.com/The-Strategy-Unit/nhp_project_information/blob/77df9d50923e5242e95226f56112d90d1ee562bf/modelling_methodology/non-demographic_growth.qmd) of this chapter that is available on GitHub.
