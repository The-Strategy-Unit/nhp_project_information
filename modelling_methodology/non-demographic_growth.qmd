...
The analyses underpinning Variant 2 are available to view [here](ndg_analysis.html) and [here](ndg2_analysis.html). The latter analysis determined the NDG rate applied to non-elective IP admissions. This work has also been published in a [peer-reviewed academic journal](https://doi.org/10.1186/s12913-025-13662-0).
A report detailing the expert elicitation exercise which underpins Variant 3 is [available here](residual_growth_elicitation_02Dec2024.pdf).
