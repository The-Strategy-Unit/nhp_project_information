...
If you have any queries, please [contact us](../contact.qmd). The code for the types of potentially mitigatable activity (TPMAs) is also now openly available in the [nhp_data repository](https://github.com/The-Strategy-Unit/nhp_data).
