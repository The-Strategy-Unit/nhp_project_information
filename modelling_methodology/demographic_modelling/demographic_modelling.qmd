...
The full methodology for generating the population catchment for demographic growth can be [seen here](https://github.com/The-Strategy-Unit/nhp_data/blob/main/src/nhp/data/reference/provider_catchments.py).
