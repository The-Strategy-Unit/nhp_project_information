...
The full methodology for generating the population catchment for demographic growth can be read from [a Python script on Github](https://github.com/The-Strategy-Unit/nhp_data/blob/main/src/nhp/data/reference/provider_catchments.py).
...
Users may request the use of a custom population projection for specific schemes, please [contact us](../contact.qmd). Any proposed alternative population projection will require the evidenced support of the ICB and region.
