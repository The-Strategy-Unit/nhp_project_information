...
The design of the modelling methodology was carried out after a review of best practice, and in particular this [review of models to project healthcare demand](https://www.york.ac.uk/media/che/documents/papers/researchpapers/CHERP186_projecting_healthcare_demand.pdf) published by the University of York.
...
The model should be regarded as a planning, rather than as a forecasting tool.  This is because future hospital activity levels emerge through the interplay of extrinsic factors such as population dynamics and technological development, and a healthcare system’s response to these factors.  This response will, in turn, be influenced by its objectives, outlook and risk appetite.  Credible estimates of future activity therefore depend not only on accurate and appropriately probabilistic estimates of extrinsic factors but also credible, explicit planning assumptions for a system’s response.  Many credible responses are possible, and if enacted faithfully, could lead to different future activity levels.  

Traditional model validation, where modelled future estimates are compared with actual values, is not meaningful in this context.  A discrepancy between these values instead reveal information about the credibility of a system’s planning assumptions and its success in implementing its plans.
