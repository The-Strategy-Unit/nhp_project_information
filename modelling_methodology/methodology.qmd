...
![Diagram of model process](model_graphic_v06.png){fig-alt="Diagram showing the processes of the model"}
...
Having determined the level of future activity after the transformations described above, the model estimates the level of capacity (beds) required to deliver it. This is based on the user-provided estimation of resource utilisation - more information on this is available in the [Capacity Conversion section](capacity_conversion/beds.qmd).
