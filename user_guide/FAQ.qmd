...
No other data should be shared as part of this work, neither data summaries with variables that increase the risk of reidentification (for example, DOB or LSOA) nor with any other parties than those described above. All of this detail is held within a DPIA approved and held by NHS England.
