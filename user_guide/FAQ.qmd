...
provided it is delivered to us in a specific format. Please see [this example](../resources/national_demographic_factors.csv) CSV  - please structure your data with the same layout, headings and file format.
...
2. Provide us with a custom birth projection in [this format](../resources/national_birth_factors.csv).
...
As an NHS team committed to open analysis, we have ensured that all of the code that can be open is currently open source. For more information on the code that is open and closed in the repository please see [here](../project_plan_and_summary/components-overview.qmd).
