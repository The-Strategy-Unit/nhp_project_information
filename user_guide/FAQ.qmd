...
As an NHS team committed to open analysis, we have ensured that all of the code that can be open is currently open source. For more information on the code that is open and closed in the repository please see [here](../user_guide/FAQ.qmd).
