...
We cannot transfer parameters from any scenarios meeting these criteria to the latest model version. Note also that any scenarios prior to v3.6 which are upgraded will have their population projection overwritten to "migration category" by default.
