...
As an NHS team committed to open analysis, we have ensured that all of the code that can be open is currently open source. For more information on the code in the repository please go to the [components overview chapter](../project_plan_and_summary/components-overview.qmd).
