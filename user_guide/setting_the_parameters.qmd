...
This input allows users to choose from the population projection variants produced by ONS. The principal population projection (not to be confused with the model's [principal projection](NHP_model_summary.qmd) of future activty) will be used across 100% of runs, as default. This is the recommended approach.
